...
let mountains = [`k2`, `nanga parbat`, `Tirchi Mir`, `broad peak`];
// making a list of the mountain series by the help of .forEach loop method.
mountains.forEach((mounts) => { console.log(mounts); });
